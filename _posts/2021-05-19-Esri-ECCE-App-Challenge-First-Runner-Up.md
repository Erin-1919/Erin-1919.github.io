...
This was the second time I participated in the Esri ECCE App Challenge, and we got the Runner-Up in the competition. It was definitely a good experience. Although everything was online and we only had two people in the team, I had to say this is the smoothest collaboration I have ever had. We used a bunch of Esri products such as ArcGIS Dashboards, ArcGIS Web AppBuilder, and ArcGIS Experience Builder. We also adopted open-sourced technologies like Jupyter Notebooks, Binder, geospatial Python packages (Geopandas, Fiona, Shapely, and H3-py). A unique feature in our projects was the usage of a Discrete Global Grid System (DGGS) to analyze and present data in the maps/apps. I hope we promoted the DGGS concepts to a broader audience.
